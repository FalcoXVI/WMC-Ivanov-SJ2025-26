...
Erweitere den Prozess. Wir brauchen zwei weitere Schritte, die nacheinander ausgeführt werden müssen:
    ...
    stempelBrief(brief): Nimmt den Brief, hängt " [Gestempelt]" an und gibt ein neues Promise zurück.

    versendeBrief(brief): Nimmt den gestempelten Brief, hängt " -> Versendet!" an und gibt ein neues Promise zurück.
