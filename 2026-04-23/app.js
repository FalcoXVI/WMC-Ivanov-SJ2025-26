...
function sortTodosByPriority() {
    todos.sort((a, b) => sortOrder === 'desc' ? b.priority - a.priority : a.priority - b.priority);
}
...
function createTodoElement(todo) {
    ...
    todoText.innerText = `${todo.text} (Priority: ${todo.priority})`;
...
sortOrderSelect.addEventListener('change', () => { sortOrder = sortOrderSelect.value; render(); });
// 8. INITIAL RENDER
